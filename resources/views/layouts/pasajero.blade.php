...
<head>
    ...
    <title>{{ env('APP_NAME') }} - Pasajero</title>
...
<div id="wrapper">
    ...
    @include('layouts.partials.sidebar-pasajero') <!-- Sidebar específico para pasajero -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            @yield('content') <!-- Contenido dinámico de pasajero -->
